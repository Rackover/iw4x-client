...
newaction {
	...
	onWorkspace = function(wks)
		...
		versionHeader:write("#define VERSION " .. cstrquote("^3IW4X-LMDN-" .. revNumber .. " ^7" .. os.date("%Y-%m-%d %H:%M:%S")) .. "\n")
		versionHeader:write("#define PLAINVERSION " .. cstrquote("IW4X-LMDN-" .. revNumber .. " " .. os.date("%Y-%m-%d %H:%M:%S")) .. "\n")
		versionHeader:write("#define SHORTVERSION " .. cstrquote("IW4X-LMDN-" .. revNumber) .. "\n")
		versionHeader:write("#define PROGRAM_NAME " .. cstrquote("Call of Duty: Modern Warfare 2") .. "\n")
		versionHeader:write("#define COMPANY_NAME " .. cstrquote("IW4x team, LMDN") .. "\n")
		versionHeader:close()
