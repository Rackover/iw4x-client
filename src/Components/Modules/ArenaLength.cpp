...
namespace Components
{
	...
	ArenaLength::ArenaLength()
	{
		...
		Utils::Hook::Set<char**>(0x4A95F0 + 3, &ArenaLength::NewArenaInfos[0]);
		Utils::Hook::Set<char**>(0x4A9620 + 3, &ArenaLength::NewArenaInfos[0]);
		Utils::Hook::Set<char**>(0x4A9653 + 3, &ArenaLength::NewArenaInfos[0]);
		Utils::Hook::Set<char**>(0x4A9684 + 3, &ArenaLength::NewArenaInfos[0]);
		Utils::Hook::Set<char**>(0x4A96B7 + 3, &ArenaLength::NewArenaInfos[0]);
		Utils::Hook::Set<char**>(0x4A97B3 + 3, &ArenaLength::NewArenaInfos[0]);
		Utils::Hook::Set<char**>(0x630A9A + 3, &ArenaLength::NewArenaInfos[0]);
